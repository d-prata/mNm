...
function verificaCampos() {
    let retorno = true;
    let usuarioExistente = JSON.parse(localStorage.getItem("usuarios") || "[]").some((usuario) => usuario.email === JSON.stringify(inputEmailSignup.value));
